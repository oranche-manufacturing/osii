...
SWEP.Stats	= {
	["Bullet"]		= {
		...
		["Spread acceleration time"]	= Range( 3, 0.3 ), -- How long it takes to accurate
		["Force"]						= 1
	},
	["Function"]	= {
		["Fire delay"]					= Range( 0.15, 0.07 ), -- Mechanical firerate, start to finish, start to finish
		["Fire acceleration time"]		= Range( 2, 1 ), -- Time to spin up/down barrels
